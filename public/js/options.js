...
$(function(){
  ...
  $optionsPanel.on('click', 'button[data-action="add"]', function () {
    ...
    var dayNum = tripModule.currentDay;



    function addAttractionToDb(dayNum, attraction){
      $.ajax({
      method: 'post',
      url: 'api/add'+attraction.type+'/'+dayNum+'/'+attraction.id
      });
    }

    addAttractionToDb(dayNum, attraction);
